...
rawowners = "<h1 style='text-align: center'>Sid <a href='https://telegram.me/sid_gil'>@Telegram</a><br></h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            <a href="https://telegram.me/sid_gil"><i class="fab fa-github"></i></a>
            <a href="https://telegram.me/sid_gil"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
